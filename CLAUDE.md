...
1. Establish credibility for a brand-new firm whose founder has unusual hybrid expertise (Ph.D. in scholarship, Software Developer certification, PHR — and currently pursuing Data Science and AI/ML Engineering credentials)
...
### CRITICAL — Avoid phantom-client language

Norrœna is a new consultancy. It does not yet have client engagements through this firm; the documented case-studies portfolio shows systems built by the operator in his current employed role. AI-generated marketing copy systematically over-claims operational maturity by writing in the present tense about client patterns ("Most clients come through X," "They stay because Y," "Every engagement does Z"). This is a recurring failure mode and must be guarded against.

**The rule:** Describe how engagements are _designed to work_, not how they _have historically worked_.

- ❌ "Most clients come to Norrœna through Draupnir" (claims observed behavior)
- ❌ "They stay because every build feeds the platform" (claims observed behavior)
- ❌ "Every Mímir engagement has been scoped..." (implies track record)
- ✅ "Draupnir is built to be a natural entry point..." (describes design intent)
- ✅ "A Mímir engagement is scoped to a defined corpus" (describes the offering)
- ✅ "Each engagement is sharply scoped" (describes how engagements are structured — fine)
- ✅ "Almost every engagement begins the same way — with an audit" (describes intended workflow — fine)

Before writing ANY claim about Norrœna's history, client base, repeat business, or "we routinely/typically X" — flag for operator verification rather than write confidently.
